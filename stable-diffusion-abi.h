...
extern "C"
{
	...
	STABLE_DIFFUSION_API uint8_t* txt2img(void* sd, sd_txt2img_options* opt, int64_t* output_size);

	STABLE_DIFFUSION_API uint8_t* img2img(void* sd, sd_img2img_options* opt, int64_t* output_size);
